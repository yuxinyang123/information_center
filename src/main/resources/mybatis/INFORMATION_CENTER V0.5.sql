...
CREATE TABLE `tbl_center_degree`  (
  ...
  `DEGREE_USERKEY` bigint(20) NOT NULL COMMENT '用户外键',
  `DEGREE_TERM` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学期',
  `DEGREE_COURSENAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程名字',
  `DEGREE_COURSENATUREC` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOU NULL COMMENT '课程类型',
  `DEGREE_CREDIT` int(8) NOT NULL COMMENT '学分',
  `DEGREE_GRADE` int(8) NOT NULL COMMENT '成绩',
  `DEGREE_PERFORMANCEPOINT` int(8) NOT NULL COMMENT '绩点',
  `DEGREE_TESTNATURE` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '考试类型',
  `DEGREE_STUDENTID` int(11) NOT NULL COMMENT '学号',
  `DEGREE_STUDENTNAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学生名字', 
...
CREATE TABLE `tbl_syllabus`(
   ...
   `SYLLABUS_WEEK` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT NULL COMMENT '星期',
   `SYLLABUS_CLASSROOM` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT NULL COMMENT '地址',
   `SYLLABUS_TEACHER` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT NULL COMMENT '教师',
