...
CREATE TABLE `tbl_center_degree`  (
  ...
  `DEGREE_CLASSNAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程名字',
  `DEGREE_CLASSNATURE` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '课程类型',
...
CREATE TABLE `tbl_syllabus`(
   ...
   `SYLLABUS_WEEK` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '星期',
   `SYLLABUS_CLASSROOM` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '地址',
   `SYLLABUS_TEACHER` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '教师',
