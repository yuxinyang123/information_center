...
if Student_id.isdigit() == True:
	with open('C:\\Users\\14832\\Desktop\\test1\\id.csv',encoding='UTF-8') as Original_File:
	...
	# 读取对照组
	with open('C:\\Users\\14832\\Desktop\\test1\\grade.csv',encoding='UTF-8' ) as Original_File:
